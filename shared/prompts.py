...
class PromptGenerator:
    ...
    def generate_prompt(self, problem: ParsedProblem, template_name: str) -> str:
        ...
        variables = {
            ...
            "input_format": self._format_input_variations(
                problem.input_format.base_format, problem.input_format.variations
            ),
    ...
    def save_successful_prompt(
        self, problem: ParsedProblem, prompt: str, solution: str, template_name: str
    ):
        ...
        success_file = (
            success_dir / f"{problem.year}_day{problem.day}_part{problem.part}.json"
        )
        data = {
