...
from .optimization import (
    CostOptimizer, ResourceManager, EnsembleOptimizer,
    ProblemComplexity, ResourceUsage
)
...
class AdaptiveSolver:
    ...
    async def solve(self,
                   problem_type: str,
                   problem_text: str,
                   available_models: List[str]) -> Optional[Solution]:
        ...
        primary_model = next(
            (model for model, model_roles in roles.items()
        ...
        for reviewer in reviewers:
            ...
            if improved_solution and improved_solution.quality_metrics.pylint_score > current_solution.quality_metrics.pylint_score:
    ...
    async def _generate_solution(self,
                               ...
                               problem_type: str,
                               problem_text: str,
                               role: ModelRole) -> Optional[Solution]:
    ...
    async def _review_solution(self,
                             ...
                             problem_type: str,
                             problem_text: str) -> Optional[Solution]:
    ...
    def _update_metrics(self,
        ...
        self.resource_manager.update_usage(
            ...
            cost=0.0 if "local" in solution.model_name.lower() else 0.01  # Example cost
        )
