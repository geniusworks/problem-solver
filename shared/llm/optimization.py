...
class CostOptimizer:
    ...
    def __init__(self, 
                 ...
                 max_response_time: float = 30.0):  # Default 30 seconds max
    ...
    def calculate_roi(self,
        ...
        # Estimate cost
        estimated_cost = (
            resource_usage.cost_per_token * 
            problem_complexity.estimated_tokens
        )
        
        # Estimate time
        estimated_time = (
            resource_usage.avg_response_time * 
        ...
        if (problem_complexity.time_constraint and 
            estimated_time > problem_complexity.time_constraint):
            performance_score *= 0.5
        
        if (problem_complexity.memory_constraint and 
            resource_usage.memory_required > problem_complexity.memory_constraint):
            performance_score *= 0.5
...
class ResourceManager:
    ...
    def get_optimal_allocation(self,
                             ...
                             models: List[str],
                             problem_complexity: ProblemComplexity) -> Dict[str, float]:
...
class EnsembleOptimizer:
    ...
    async def optimize_ensemble(self,
        ...
        local_model = next(
            (model for model, _ in model_scores
