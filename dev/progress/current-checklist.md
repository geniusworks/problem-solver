...
- [x] Test and refine the weighted consensus system with real problems and add unit tests for `_get_weighted_consensus_answer`.
...
- [x] Integrate problem type into `get_top_models` and strategy recommendation.
